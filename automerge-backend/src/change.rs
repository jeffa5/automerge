...
fn group_doc_change_and_doc_ops(
    ...
    for (i, change) in changes.iter().enumerate() {
        println!("{} {:?} {}", i, actor_max, change.seq);
...
mod tests {
    ...
    #[test]
    fn test_doc_changes_grouping() {
        let actor_uuid = uuid::Uuid::new_v4();
        let actor_id = ActorId::from_bytes(actor_uuid.as_bytes());
        let actor_uuid_2 = uuid::Uuid::new_v4();
        let actor_id_2 = ActorId::from_bytes(actor_uuid_2.as_bytes());
        ...
        let mut ops = vec![
            DocOp {
                actor: 0,
                ctr: 1,
                action: amp::OpType::Make(amp::ObjType::Map(amp::MapType::Map)),
                obj: amp::ObjectId::Root,
                key: amp::Key::Map("tasks".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                ctr: 2,
                action: amp::OpType::Make(amp::ObjType::Map(amp::MapType::Map)),
                obj: amp::ObjectId::Id(amp::OpId(1, actor_id.clone())),
                key: amp::Key::Map("7f7bfd16-b601-4511-a3bd-0acd4a550128".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Make(amp::ObjType::Map(amp::MapType::Map)),
                obj: amp::ObjectId::Id(amp::OpId(1, actor_id.clone())),
                key: amp::Key::Map("e770252e-a0f7-4b8e-9270-dd240ff1f150".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                actor: 0,
                ctr: 18,
                action: amp::OpType::Make(amp::ObjType::Sequence(amp::SequenceType::List)),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("depends".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                actor: 0,
                ctr: 16,
                action: amp::OpType::Set(amp::ScalarValue::Str("".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![(44, 1)],
                pred: vec![],
                insert: false,
            },
            DocOp {
                actor: 1,
                ctr: 44,
                action: amp::OpType::Set(amp::ScalarValue::Str("s".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![(45, 1), (45, 1)],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 45,
                action: amp::OpType::Set(amp::ScalarValue::Str("ss".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 46,
                action: amp::OpType::Set(amp::ScalarValue::Str("sss".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![(47, 1), (47, 1)],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 47,
                action: amp::OpType::Set(amp::ScalarValue::Str("ssss".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![(48, 1)],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 48,
                action: amp::OpType::Set(amp::ScalarValue::Str("sssss".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 49,
                action: amp::OpType::Set(amp::ScalarValue::Str("ssssss".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![],
                pred: vec![],
            ...
            DocOp {
                actor: 0,
                ctr: 6,
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("due".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            ...
            DocOp {
                actor: 0,
                ctr: 17,
                action: amp::OpType::Set(amp::ScalarValue::Timestamp(1616883726)),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("entry".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Set(amp::ScalarValue::Str("".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("notes".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("parent".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("priority".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Make(amp::ObjType::Sequence(amp::SequenceType::List)),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("project".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("recur".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("scheduled".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("start".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                action: amp::OpType::Make(amp::ObjType::Map(amp::MapType::Map)),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("status".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            ...
            DocOp {
                ...
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(2, actor_id.clone())),
                key: amp::Key::Map("until".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            ...
            DocOp {
                ...
                ctr: 5,
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(4, actor_id.clone())),
                key: amp::Key::Map("Pending".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            },
            DocOp {
                ...
                ctr: 26,
                action: amp::OpType::Make(amp::ObjType::Sequence(amp::SequenceType::List)),
                obj: amp::ObjectId::Id(amp::OpId(21, actor_id_2.clone())),
                key: amp::Key::Map("depends".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
            ...
            DocOp {
                actor: 1,
                ctr: 40,
                action: amp::OpType::Set(amp::ScalarValue::Str("a".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(21, actor_id_2.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![(41, 1), (41, 1)],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 41,
                action: amp::OpType::Set(amp::ScalarValue::Str("ar".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(21, actor_id_2.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![(42, 1)],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 42,
                action: amp::OpType::Set(amp::ScalarValue::Str("ars".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(21, actor_id_2.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![(43, 1)],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 43,
                action: amp::OpType::Set(amp::ScalarValue::Str("arst".to_owned())),
                obj: amp::ObjectId::Id(amp::OpId(21, actor_id_2.clone())),
                key: amp::Key::Map("description".to_owned()),
                succ: vec![],
                pred: vec![],
            ...
            DocOp {
                actor: 1,
                ctr: 24,
                action: amp::OpType::Set(amp::ScalarValue::Timestamp(1616884535)),
                obj: amp::ObjectId::Id(amp::OpId(21, actor_id_2.clone())),
                key: amp::Key::Map("entry".to_owned()),
                succ: vec![],
                pred: vec![],
            ...
            DocOp {
                ...
                ctr: 28,
                action: amp::OpType::Set(amp::ScalarValue::Null),
                obj: amp::ObjectId::Id(amp::OpId(27, actor_id_2.clone())),
                key: amp::Key::Map("Pending".to_owned()),
                succ: vec![],
                pred: vec![],
                insert: false,
        ...
        let actors = vec![actor_id.clone(), actor_id_2.clone()];

        group_doc_change_and_doc_ops(&mut changes, &mut ops, &actors).unwrap();
    }
}
